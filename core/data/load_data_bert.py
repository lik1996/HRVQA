...
class DataSet(Data.Dataset):
    def __init__(self, __C):
        ...
        # {question id} -> {question dictionary}
        ...
        self.ans_to_ix, self.ix_to_ans = ans_stat('/home/lik/data/VHR-QA/jsons/mutan/answer_dic.json')
