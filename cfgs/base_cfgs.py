...
class Cfgs(PATH):
    def __init__(self):
        ...
        self.CKPT_PATH = '/home/lik/code/vhrqa/ckpts/ckpt_vhrqa_grid_oursv1_1024_new_v2/epoch13.pkl'
        # self.CKPT_PATH = None
        ...
        # Default training batch size: 32
        self.BATCH_SIZE = 2
        ...
        self.LAYER = 6 # first additional ablation study: 2, 4, 6, 8
