...
def parse_args():
    ...
    '''
    parser = argparse.ArgumentParser(description='hrvqa Args')
    ...
    parser.add_argument('--METHOD', dest='MODEL_METHOD',
                      choices=['mca', 'mca_ca', 'trar', 'mca_fu', 'mca_aoa', 'mca_ga, oursv1'],
                      help='{mca, mca_ca, trar, mca_fu, mca_aoa, mca_ga}',
                      default='oursv1', type=str)
